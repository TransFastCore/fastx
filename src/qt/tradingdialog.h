...
private slots:
    ...
    QString BuyFASTX(QString OrderType, double Quantity, double Rate);
    QString SellFASTX(QString OrderType, double Quantity, double Rate);
