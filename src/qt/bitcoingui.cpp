...
{
	resize(900, 520);
	setWindowTitle(tr("TransFast") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
	setObjectName("TransFast");
	setStyleSheet("#TransFast { background-color: #202020; border-image: url(':/images/bg') 0 0 0 0 stretch stretch;}");
	//qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
	// Accept D&D of URIs
	setAcceptDrops(true);
	...
	statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #101010, stop: 1 #202020);  }");
...
void BitcoinGUI::createActions()
{
	...
	sendCoinsAction->setToolTip(tr("Send coins to a TransFast address"));
	...
	aboutAction = new QAction(QIcon(":/icons/bitcoin1"), tr("&About TransFast"), this);
	aboutAction->setToolTip(tr("Show information about TransFast"));
	aboutAction->setMenuRole(QAction::AboutRole);
	aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
	aboutQtAction->setToolTip(tr("Show information about Qt"));
	aboutQtAction->setMenuRole(QAction::AboutQtRole);
	optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setToolTip(tr("Modify configuration options for TransFast"));
...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 13px; font-weight: 400; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; }"
		"QToolButton:hover { background-color: #000000; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:checked { background-color: #000000; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:pressed { background-color: #000000; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"#tabs { color: #ffffff; background-color: #202020; border: none; padding-top: 0px; padding-bottom: 0px; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
	...
	if (clientModel)
	{
		...
		if (clientModel->isTestNet())
		{
			...
			if (trayIcon)
			{
				trayIcon->setToolTip(tr("TransFast client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
	...
	trayIcon->setToolTip(tr("TransFast client"));
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TransFast network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
	...
	else
	{
		...
		progressBarLabel->setStyleSheet("QLabel { color: #ffffff; margin-left: 152px;}");
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
	if (event->mimeData()->hasUrls())
	{
		...
		if (nValidUrisFound)
			...
			notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid TransFast address or malformed URI parameters."));
	}
